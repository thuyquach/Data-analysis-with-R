...
```{r load packages, echo=FALSE, message=FALSE, warning=FALSE, packages}
...
```{r load data, echo=FALSE, message=FALSE, warning=FALSE, packages}
getwd()
...
```{r data summary, echo=FALSE, message=FALSE, warning=FALSE, packages}
...
```{r distribution plot, echo=FALSE, message=FALSE, warning=FALSE, packages}
...
```{r boxplot, echo=FALSE, message=FALSE, warning=FALSE, packages}
...
```{r Correlations matrix, echo=FALSE, message=FALSE, warning=FALSE, packages}
...
```{r scatterplot, echo=FALSE, message=FALSE, warning=FALSE, packages}
# scatterplot
...
```{r cor coeff, echo=FALSE, message=FALSE, warning=FALSE, packages}
...
```{r correlation graph, echo=FALSE, message=FALSE, warning=FALSE, packages}
...
```{r new rating variable, echo=FALSE, message=FALSE, warning=FALSE, packages}
...
```{r summary of wine by rating, echo=FALSE, message=FALSE, warning=FALSE, packages} 
...
```{r selected variables  vs quality, echo=FALSE, message=FALSE, warning=FALSE, packages}
...
```{r plot quality vs selected varibles, echo=FALSE, message=FALSE, warning=FALSE, packages}
...
```{r cor coeff plot, echo=FALSE, message=FALSE, warning=FALSE, packages} 
...
```{r pH and alcohol vs quality,echo=FALSE, message=FALSE, warning=FALSE, packages }
plot12 <- ggplot(redwine, aes(x= pH, y = alcohol, color = quality)) + geom_point()
plot12
```

```{r}
plot13 <- ggplot(quality_vs_total_variables, aes(x= avg_citric.acid, y = avg_alcohol)) + geom_point(aes(size = quality)) + ggtitle("Relationship of average alcohol and average citric.acid sorted by quality")
plot13
```

```{r}
plot20 <- ggplot(quality_vs_total_variables, aes(x= avg_citric.acid, y = avg_alcohol)) + geom_point(aes(size = quality)) + ggtitle("Relationship of average alcohol and average citric.acid sorted by quality")
plot20
```
...
```{r pH alcohol rating}
plot14 <- ggplot(wine_table, aes(x= pH, y = alcohol, color = rating)) + geom_point(aes(size = rating))
plot14
```

```{r citric.acid alcohol rating}
plot15 <- ggplot(wine_table, aes(x= citric.acid, y = alcohol, color = rating)) + geom_point(aes(size = rating))
plot15
```

```{r citric.acid pH rating}
plot16 <- ggplot(wine_table, aes(x= citric.acid, y = pH, color = rating)) + geom_point(aes(size = rating)) + ggtitle("Relationship of alcohol and citric.acid sorted by rating")
plot16
```

```{r}
plot17 <- ggplot(rating_vs_variables, aes(x= avg_citric.acid, y = avg_alcohol)) + geom_point(aes(size = rating)) + ggtitle("Relationship of average alcohol and average citric.acid sorted by rating")
plot17
```

```{r}
plot18 <- ggplot(rating_vs_variables, aes(x= avg_sulphates, y = avg_alcohol)) + geom_point(aes(size = rating)) + ggtitle("Relationship of average alcohol and average sulphates sorted by rating")
plot18
```

```{r}
plot19 <- ggplot(rating_vs_variables, aes(x= avg_sulphates, y = avg_citric.acid)) + geom_point(aes(size = rating)) + ggtitle("Relationship of average citric.acid and average sulphates sorted by rating")
plot19
```

```{r}
plot21 <- ggplot(rating_vs_variables, aes(x= avg_volatile.acidity, y = avg_citric.acid)) + geom_point(aes(size = rating)) + ggtitle("Relationship of average citric.acid and average sulphates sorted by rating")
plot21
```


```{r}
plot22 <- ggplot(rating_vs_variables, aes(x= avg_volatile.acidity, y = avg_alcohol)) + geom_point(aes(size = rating)) + ggtitle("Relationship of average citric.acid and average sulphates sorted by rating")
plot22
```


```{r}
plot23 <- ggplot(rating_vs_variables, aes(x= avg_volatile.acidity, y = avg_sulphates)) + geom_point(aes(size = rating)) + ggtitle("Relationship of average citric.acid and average sulphates sorted by rating")
plot23
```
